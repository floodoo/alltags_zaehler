...
class HorizontalBarChartWithSecondaryAxis extends StatelessWidget {
  ...
  static List<charts.Series<OrdinalSales, String>> _createSampleData() {
    final globalSalesData = [
      new OrdinalSales('29.01.2020', 5000),
      new OrdinalSales('30.01.2020', 25000),
      new OrdinalSales('31.01.2020', 100000),
      new OrdinalSales('01.02.2020', 750000),
    ];

    final losAngelesSalesData = [
      new OrdinalSales('29.01.2020', 500),
      new OrdinalSales('30.01.2020', 200),
      new OrdinalSales('31.01.2020', 5000),
      new OrdinalSales('01.02.2020', 400),
    ];
